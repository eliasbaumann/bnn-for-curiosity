...
# from tf.layers import Layer,InputSpec
...
# from: https://github.com/Skydes/Concrete-Dropout/ # based on gal paper: concrete dropout

class ConcreteDropout(tf.layers.Layer):
    ...
    def call(self, inputs, training=True):
        ...
        return tf.contrib.framework.smart_cond(training,
                                dropped_inputs,
